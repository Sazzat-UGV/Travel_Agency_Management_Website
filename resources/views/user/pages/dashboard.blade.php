                    ...
                    <div class="col-6">
                        <div class="counter-single">
                            <div class="counter-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 51 51">
                            ...
                            <div class="counter-content">
                                <p>Total Booking</p>
                                <div class="number">
                                    <h3 class="counter">{{ $total_completed_order }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="counter-single two">
                            ...
                            <div class="counter-content">
                                <p>Total Reviews</p>
                                <div class="number">
                                    <h3 class="counter">{{ $total_review }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="recent-listing-area">
                ...
                <div class="recent-listing-table">
                    <table class="eg-table2">
                        ...
                        <tbody>
                            @foreach ($latest_booking as $index => $booking)
                                <tr>
                                    <th>
                                        {{ $index + 1 }}
                                    </th>
                                    ...
                                    <td class="align-items-center text-center">
                                        <button class="btn btn-secondary btn-sm mb-1 px-3" data-bs-toggle="modal"

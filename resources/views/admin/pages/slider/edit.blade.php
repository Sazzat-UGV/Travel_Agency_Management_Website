...
@endpush
@section('content')
    @include('admin.layout.inc.breadcumb', ['main_page' => 'Sliders', 'sub_page' => 'Edit Slider'])
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('slider.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        is-invalid
                        @enderror"
                                    placeholder="Enter slider text" id="text">{{ old('text', $slider->text) }}</textarea>
                                @error('text')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            is-invalid
                        @enderror"
                                    data-default-file="{{ asset('uploads/slider') }}/{{ $slider->photo }}"

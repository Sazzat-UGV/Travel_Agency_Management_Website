            ...
            <div class="card-body">
                <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        is-invalid
                        @enderror"
                                    placeholder="Enter short description" id="short_description">{{ old('short_description') }}</textarea>
                        ...
                        is-invalid
                        @enderror"
                                    placeholder="Enter description" id="editor">{{ old('description') }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>

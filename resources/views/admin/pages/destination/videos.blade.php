    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <h5>Videos of {{ $destination->name }}</h5>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <tbody>
                            @foreach ($videos as $index => $video)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.destination_video_delete', $video->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
        ...
        <div class="col-5">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.destination_video_submit', $destination->id) }}" method="POST">
                        @csrf
                        <div>

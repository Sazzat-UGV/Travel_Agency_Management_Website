...
@section('content')
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('admin.userEditSubmit', $user->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-6">
                            ...
                            is-invalid
                            @enderror"
                                    id="name" placeholder="Enter user name" name="name"
                        ...
                        <div class="col-3">
                            ...
                            is-invalid
                            @enderror"
                                    id="zip" placeholder="Enter user zip" name="zip"
                        ...
                        <div class="col-12">
                            <div>
                                ...
                                <input type="file"
                                    data-default-file="{{ asset('uploads/user') }}/{{ $user->photo }}"

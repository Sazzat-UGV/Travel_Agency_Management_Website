                        ...
                        <div class="col-sm-6">
                            <div class="invoice-logo">
                                ...
                                <div class="logo">
                                    ...
                                    <img src="{{ asset('uploads/setting/default_logo.png') }}" class="h-25 w-auto" alt="logo">
                                    @else
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="invoice-number mb-30">
                                ...
                                <h2 class="name mb-10">{{ $invoice->user->name }}</h2>
                                <p class="invo-addr-1">
                        ...
                        <div class="col-sm-6">
                            <div class="invoice-number mb-30">
                                <div class="invoice-number-inner">
                                    ...
                                    <h2 class="name mb-10">{{ Auth::guard('admin')->user()->name }}</h2>
                                    <p class="invo-addr-1">
                                        {{ Auth::guard('admin')->user()->email }}<br />
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table mb-0 table-striped invoice-table">
                            ...
                            <tbody>
                                <tr class="tr">
                                    ...
                                    <td class="pl0">
                                        <strong>Start Date:</strong> {{ date("d m Y", strtotime($invoice->tour->tour_start_date))}}</br>
                                        <strong>End Date:</strong> {{ date("d m Y", strtotime($invoice->tour->tour_end_date))}}</br>
                                    </td>
                        ...
                        <div class="col-lg-6 col-md-4 col-sm-5">
                            <div class="mb-30 payment-method">
                                ...
                                <ul class="payment-method-list-1 text-14">
                                    ...
                                    <li><strong>Payment Status:</strong> @if ($invoice->payment_status=='Completed')
                        ...
                        <div class="col-lg-10 col-md-11 col-sm-12">
                            <div class="contact-info">
                                ...
                                <a href="javascript:void(0)" class="mr-0 d-none-580"><i
                                        class="fa fa-map-marker"></i> {{ $setting->address }}</a>
                            </div>
                        </div>
                    </div>

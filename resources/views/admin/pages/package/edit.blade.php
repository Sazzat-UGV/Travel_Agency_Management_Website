            ...
            <div class="card-body">
                <form action="{{ route('package.update', $package->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        is-invalid
                        @enderror"
                                    placeholder="Enter package description" id="description">{{ old('description', $package->description) }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                            ...
                            <select
                                ...
                                @foreach ($destinations as $destination)
                                    <option value="{{ $destination->id }}"
                                        @if ($destination->id == $package->destination_id) selected
                                            @elseif (old('destination') == $destination->id)
                                            selected @endif>
                        ...
                        is-invalid
                        @enderror"
                                    placeholder="Enter package map">{{ old('map', $package->map) }}</textarea>
                                @error('map')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        ...
                        @enderror"
                                    ...
                                    data-default-file="{{ asset('uploads/package') }}/{{ $package->featured_photo }}"

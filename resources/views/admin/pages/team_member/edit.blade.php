...
@section('content')
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('team_member.update',$team_member) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            @enderror"
                                    ...
                                    value="{{ old('phone',$team_member->phone) }}">
                                @error('phone')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                @enderror"
                                    ...
                                    value="{{ old('address',$team_member->address) }}">
                                @error('address')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        ...
                        is-invalid
                        @enderror"
                                    placeholder="Enter team member biography" id="editor">{{ old('biography',$team_member->biography) }}</textarea>
                                @error('biography')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('facebook',$team_member->facebook) }}">
                                @error('facebook')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('twitter',$team_member->twitter) }}">
                                @error('twitter')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('instagram',$team_member->instagram) }}">
                                @error('instagram')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <input type="file" data-default-file="{{ asset('uploads/team_member') }}/{{ $team_member->photo }}"

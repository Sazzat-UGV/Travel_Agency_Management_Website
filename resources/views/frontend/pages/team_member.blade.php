                                ...
                                @if (
                                    ...
                                    <ul class="social-list d-flex justify-content-center">
                                        @if ($team_member->facebook)
                                            <li>
                                                <a href="{{ $team_member->facebook }}"><i class="bx bxl-facebook"></i></a>
                                            </li>
                                        @endif
                                        ...
                                        @if ($team_member->instagram)
                                            <li>
                                                <a href="{{ $team_member->instagram }}"><i class="bx bxl-instagram"></i></a>
                                            </li>
                                        @endif
                                        @if ($team_member->linkedin)
                                            <li>
                                                <a href="{{ $team_member->linkedin }}"><i class="bx bxl-linkedin"></i></a>
                                            </li>
                                        @endif
                                    </ul>
                                @endif

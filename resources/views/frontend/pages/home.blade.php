                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center mb-40">
                            ...
                            <h2>Explore our most latest travel packages around the world </h2>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="package-card">
                                ...
                                <div class="package-card-content">
                                    <div class="card-content-top">
                                        <h5><a href="{{ route('package', $package->slug) }}">{{ $package->name }}</a></h5>
                                    ...
                                    <div class="card-content-bottom">
                                        ...
                                        <a href="{{ route('package', $package->slug) }}" class="primary-btn2">Book a Trip
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="allreview" role="tabpanel"
                                    ...
                                    <div
                                        ...
                                        <div class="swiper-wrapper" id="swiper-wrapper-3531ea6f29ee9242" aria-live="off"

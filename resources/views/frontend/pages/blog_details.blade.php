...
@section('content')
    @include('frontend.layout.inc.breadcrumb', [
        ...
        'parent_page_name' => 'Blog',
        'parent_page_link' => route('blog'),
            ...
            <div class="row g-lg-4 gy-5 justify-content-center">
                <div class="col-lg-8">
                    <div class="post-thumb mb-30">
                        <img src="{{ asset('uploads/blog') }}/{{ $blog->photo }}" alt="Blog Photo">
                    </div>
                    ...
                    <div class="blog-meta two mb-50">
                        <ul>
                            ...
                            <li>
                                ...
                                <a
                                    href="{{ route('category', $blog->blog_category->slug) }}">{{ $blog->blog_category->name }}</a>
                            </li>

                        </ul>
                    </div>
                    <p class="first-para">{!! $blog->description !!}</p>
                            ...
                            @foreach ($latest_blogs as $latest_blog)
                                <div class="recent-post-widget mb-20">
                                    <div class="recent-post-img">
                                        <a href="{{ route('blog_details', $latest_blog->slug) }}"><img
                                                src="{{ asset('uploads/blog') }}/{{ $latest_blog->photo }}"
                                                alt="Blog Photo"></a>
                                    </div>
                                    <div class="recent-post-content">
                                        <a href="#">{{ $latest_blog->created_at->format('d F, Y') }}</a>
                                        <h6><a
                                                href="{{ route('blog_details', $latest_blog->slug) }}">{{ Str::words($latest_blog->title, 10, '...') }}</a>
                                        </h6>
                                    </div>
                                </div>
                            @endforeach
